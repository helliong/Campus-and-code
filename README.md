...
- Административный раздел для управления товарами и заявками на верификацию.
...
Проект можно запускать локально и использовать как прототип магазина: смотреть каталог, добавлять товары в корзину и избранное, редактировать профиль, отправлять заявку на подтверждение статуса студента, управлять товарами и заявками в админке.
...
- автоматическими тестами покрыта часть логики корзины, избранного и синхронизации API routes; checkout пока не покрыт;
...
- Улучшить поиск, сортировку и пагинацию каталога.
